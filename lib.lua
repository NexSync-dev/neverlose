--ALL CREDITS TO https://github.com/l1l1l1l1l11l1l1l1l11/Neverlose-Main/
...
function library:window(properties)
    local cfg = { 
        ...
        logo = properties.logo or properties.Logo or "rbxassetid://0";
...
function library:Tab(properties)
    local cfg = {
        ...
        icon = properties.icon or properties.Icon or "http://www.roblox.com/asset/?id=101616085938229";
